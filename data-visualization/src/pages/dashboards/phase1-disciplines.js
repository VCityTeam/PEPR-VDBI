import { countEntities, exclude, sparkbar } from '/components/utilities.js'
...
export const cnu_plot_legend_options = {
  marginLeft: 18,
  marginRight: 300,
  domain: [1, 0.1],
  range: [1, 0.4],
...
export function generateCnuPlotOptions(
  data,
  sort = 'y',
  height = 350,
  width = 500,
...
// Table //
export const generateSparkbar = sparkbar(1, {
