...
const all_institutions_by_project_query = `
  select distinct project, institution_id from (
    select
...
const reader = await connection.runAndReadAll(all_institutions_by_project_query)
